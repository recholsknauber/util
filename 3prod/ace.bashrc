...
alias gitsku="cp ~/.emacs ~/util/3prod/ace.emacs; cp ~/.bashrc ~/util/3prod/ace.bashrc; cd ~/kar; git add .; git commit -m '<(-.0<)'; git push origin master; cd ~/util; git add .; git commit -m '<(-.0<)'; git push origin master; cd ~;"
